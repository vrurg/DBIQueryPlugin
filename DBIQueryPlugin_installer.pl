#! /usr/bin/env perl
#
# Install script for DBIQueryPlugin
#
...
Foswiki::Extender::install( $PACKAGES_URL, 'DBIQueryPlugin', 'DBIQueryPlugin',
    @DATA );
...
__DATA__
<<<< MANIFEST >>>>
data/System/DBIQueryPlugin.txt,0644,779224172dd45874ebdedf128c0f3e16,Documentation page (noci)
data/System/VarDBI_QUERY.txt,0644,8709576c730af173db46da412a517f49,Tag documentation (noci)
data/Sandbox/PluginTestDBIQueryPlugin.txt,0644,665f783e8de99e22e0c98ad39786651c,Examples (noci)
lib/Foswiki/Plugins/DBIQueryPlugin.pm,0444,0eed8099d30d31e72a30446a012c7776,Perl module (noci)
lib/Foswiki/Plugins/DBIQueryPlugin/Config.spec,0444,fd0bd3518f74682f1d9377dbbd8babd6,Configuration (noci)
